      ...
      <div className="terms-main">
        ...
        <div className="terms-para">
          ...
          <p>
            ...
            <Link to="http://www.nomadnurse.co.uk/">www.nomadnurse.co.uk</Link>{" "}
            (our site). 
          </p>
          <h4>
          ...
          <ul>
            ...
            <li>Our trade marks are registered.</li>
          </ul>
          <h4>Who we are and how to contact us</h4>
          <p>
            <Link to="http://www.nomadnurse.co.uk/">www.nomadnurse.co.uk</Link>{" "}
            is a site operated by Nomad Locum Limited ("We"). 
          </p>
          <p>
            We are registered in England and Wales under company number 08133178
            and have our registered office at {"{TBC}"}. Our main trading
            address is {"{TBC}"}. Our VAT number is{"{TBC}"}. 
          </p>
          <p>We are a limited company. </p>
          <p>To contact us, please email info@smilefast.com. </p>
          <br />
          ...
          <p>
            ...
            rights and obligations under these terms to another organisation. We
            will always tell you in writing if this happens and we will ensure
          ...
          <h4>No text or data mining, or web scraping</h4>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              data in digital form to generate information which includes but is
          ...
          <p>
            ...
            we are unable to exclude or limit text or data mining or web
